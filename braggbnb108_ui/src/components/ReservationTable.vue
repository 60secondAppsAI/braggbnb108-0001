...
<template>
  ...
  <base-input label="CheckinDate" type="text" placeholder="Enter CheckinDate" v-model="reservationToAdd.checkinDate"></base-input>
  <base-input label="CheckoutDate" type="text" placeholder="Enter CheckoutDate" v-model="reservationToAdd.checkoutDate"></base-input>
                  </form>
                </div>
